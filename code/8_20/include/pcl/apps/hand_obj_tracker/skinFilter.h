...
#ifndef PCL_SKIN_FILTER_H_
#define PCL_SKIN_FILTER_H_
...
namespace pcl
{
	...
	class skinFilter :	public PCLBase<PointT>
	{
    ...
    using PCLBase<PointT>::deinitCompute;
      ...
      typedef typename PointCloud::ConstPtr PointCloudConstPtr;
			...
			skinFilter () : total_sample_number(0),skin_Tmax(0.5),skin_Tmin(0.2),skin_P_s(0),
												sampleFull(false),spacing(4),stored_frames(0),skin_P_s_w(0),
			...
			/** \find skin cloud */
			void
			identifySkin (PointCloud &cloud_skin, PointCloud &cloud_skin2, PointCloud &cloud_other);
...
#endif  //#ifndef PCL_SKIN_FILTER_H_