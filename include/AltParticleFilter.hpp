#ifndef ALT_PARTICLE_FILTER_H
#define ALT_PARTICLE_FILTER_H
...
class AltParticleFilter : public Algorithm
{
public:
  ...
  AltParticleFilter(std::string, std::string);
  ...
  bool DrawParticles(Eigen::Affine3f pcaRot);  
};
